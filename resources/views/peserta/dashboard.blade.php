...
<div class="container-fluid px-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4 bg-white">
        <div class="card-body p-4">
            <h4 class="fw-bold text-dark mb-1">Selamat datang, Shela Pitriani!</h4>
                ...
                <div class="card-body d-flex flex-column justify-content-between">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <h5 class="fw-bold text-dark mb-1">Junior Web Developer</h5>
                ...
                <div class="card-body d-flex flex-column justify-content-between">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <h5 class="fw-bold text-dark mb-1">20 Agustus 2026</h5>
                        </div>
                    </div>
                    <div class="text-secondary small d-flex flex-column gap-1">
                        <div><i class="bi bi-clock me-1 text-primary"></i> 08.00 - 16.00 WIB</div>
                        <div><i class="bi bi-geo-alt me-1 text-primary"></i> Lab Komputer 1</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm rounded-4 h-100 p-3">
                <div class="card-body d-flex flex-column justify-content-between">
                    <div>
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <div class="rounded-circle d-flex align-items-center justify-content-center text-danger" style="width: 50px; height: 50px; background-color: #fde8e8; flex-shrink: 0;">
                                <i class="bi bi-qr-code-scan fs-5"></i>
                            </div>
                            <div>
                                <span class="text-muted small d-block">Status Absensi</span>
                                <h5 class="fw-bold text-danger mb-0">Belum Absen</h5>
                            </div>
                        </div>
                        <p class="text-muted small mb-4">Scan QR Code saat ujian berlangsung.</p>
                    </div>
                    <div>
                        <!-- Tombol Scan QR memanggil fungsi openScanner() -->
                        <button type="button" class="btn btn-primary px-4 py-2 rounded-pill fw-semibold shadow-sm border-0 d-inline-flex align-items-center gap-2" onclick="openScanner()" style="background-color: #0d6efd; font-size: 0.9rem;">
                ...
                <div class="card-body d-flex flex-column justify-content-between">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <h5 class="fw-bold text-dark mb-0">Belum Diumumkan</h5>
                        </div>
                    </div>
                    <p class="text-muted small mb-0">
                        Hasil penilaian akan diumumkan setelah proses uji selesai.
                    </p>
                </div>
            </div>
        </div>
