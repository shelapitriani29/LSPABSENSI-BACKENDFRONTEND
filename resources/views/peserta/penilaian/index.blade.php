    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center pb-3 mb-4 border-bottom gap-3">
                ...
                <div>
                    <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-pill fw-bold d-inline-flex align-items-center gap-1" style="font-size: 0.85rem;">
                        <i class="bi bi-check-circle-fill"></i> KOMPETEN
                    </span>
                </div>
            </div>

            <!-- Detail Informasi (Asesor, Tanggal, Hasil) -->
            <div class="mb-4" style="font-size: 0.95rem;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-8 fw-semibold text-success">
                        : KOMPETEN
                    </div>
                </div>
            </div>
