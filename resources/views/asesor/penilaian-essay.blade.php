...
<div class="container-fluid px-0">
    ...
    <div class="card border-0 shadow-sm rounded-3 bg-white mb-5">
        <form action="{{ route('asesor.penilaian-essay.store') }}" method="POST" id="formNilaiEssay">
            @csrf
            <input type="hidden" name="penilaian_id" value="{{ $penilaian_id ?? 1 }}">
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2" style="max-width: 180px;">
                        <input type="number" step="0.01" name="nilai_essay" class="form-control form-control-sm text-center fw-bold text-dark shadow-sm py-2 @error('nilai_essay') is-invalid @enderror" value="{{ old('nilai_essay', '80.00') }}" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="catatan_essay" class="form-control text-dark shadow-sm @error('catatan_essay') is-invalid @enderror" rows="3" placeholder="Isi Catatan (Opsional)" style="font-size: 0.9rem;">{{ old('catatan_essay', 'Jawaban sudah cukup baik dan sesuai konsep yang diharapkan.') }}</textarea>
