        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-3 p-4">
                ...
                <div class="d-flex align-items-center mb-4 pb-4 border-bottom">
                    <div class="rounded-circle text-white d-flex align-items-center justify-content-center fw-bold me-3 shadow-sm" style="width: 80px; height: 80px; font-size: 1.8rem; background-color: #1E6388;">
                        BS
                    </div>
                    <div>
                        <button class="btn btn-outline-secondary btn-sm mb-1 px-3 py-1" style="font-size: 0.8rem;">
                    ...
                    <table class="table table-borderless align-middle mb-0" style="font-size: 0.9rem;">
                        <tbody>
                            <tr>
                                ...
                                <td class="fw-bold text-dark py-2">: Budi Santoso</td>
                            </tr>
                            <tr>
                                <td class="text-secondary py-2">No. Registrasi / MET</td>
                                <td class="fw-bold text-dark py-2">: MET.000.123456 2023</td>
                            </tr>
                            <tr>
                                <td class="text-secondary py-2">Bidang / Kompetensi</td>
                                <td class="fw-bold text-dark py-2">: Junior Web Developer & Software Engineering</td>
                            </tr>
                            <tr>
                                <td class="text-secondary py-2">Email</td>
                                <td class="fw-bold text-dark py-2">: budi.santoso@lsp1.sch.id</td>
                            </tr>
                            <tr>
                                <td class="text-secondary py-2">Role</td>
                                <td class="py-2">
                                    <span class="badge px-2 py-1 text-white" style="font-size: 0.75rem; font-weight: 500; background-color: #1E6388;">Asesor</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary py-2">Bergabung Sejak</td>
                                <td class="fw-bold text-dark py-2">: 15 Januari 2023</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
